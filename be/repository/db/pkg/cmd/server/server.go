...
import (
	...
	"github.com/mvp-eXpress/3g-todo-fullstack/be/repository/db/pkg/protocol/grpc"
	v1 "github.com/mvp-eXpress/3g-todo-fullstack/be/repository/db/pkg/service/v1"
)
...
func RunServer() error {
	...
	v1API := v1.NewToDoServiceServer(coll)
